...
import { minerTypes } from '@/lib/miners';
...
interface HiringStationProps {
  ...
  onHire: (type: 'basic' | 'expert' | 'hauler' | 'prospector' | 'engineer') => void;
}
...
export const HiringStation = ({ money, miners, onHire }: HiringStationProps) => {
  ...
  return (
    <div className="p-4 animate-fade-in">
      <h2 className="text-xl font-bold mb-5 pixel-font text-center">Hire Miners</h2>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium pixel-font capitalize">{type} Miner</span>
                </div>
